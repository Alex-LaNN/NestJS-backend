...
export class LastMigration1718564931891 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`films_vehicles\` DROP FOREIGN KEY \`FK_d892418f6e02d0ebce56bd35809\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`films_vehicles\` DROP FOREIGN KEY \`FK_4465b1c1a89520616f3c6ccad73\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`people_vehicles\` DROP FOREIGN KEY \`FK_f858faa2a7663a7258052fb4e54\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`people_vehicles\` DROP FOREIGN KEY \`FK_1228470b9119a37bc0608e7ac62\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`people_films\` DROP FOREIGN KEY \`FK_a6ae8e23d835bdbc6b9fe43823f\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`people_films\` DROP FOREIGN KEY \`FK_f9d0038e205e511024d88b4c441\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`films_planets\` DROP FOREIGN KEY \`FK_a8db04b134255125a4a990c656d\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`films_planets\` DROP FOREIGN KEY \`FK_56eec3c43f5246c6a26f4e61d81\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`films_species\` DROP FOREIGN KEY \`FK_30663fc8495f09199efa33ab85e\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`films_species\` DROP FOREIGN KEY \`FK_b5b68c8f3779bcdaa9afda0378e\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`people_species\` DROP FOREIGN KEY \`FK_56f67794e6fc76cd1c1427ed1a6\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`people_species\` DROP FOREIGN KEY \`FK_3f0fe0fa1df5ad0ef0afc4e9fbf\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`people_starships\` DROP FOREIGN KEY \`FK_25cb50d5fba38a9219e6b2eb79e\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`people_starships\` DROP FOREIGN KEY \`FK_2ee1350798626e1c52a83f26c0f\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`films_starships\` DROP FOREIGN KEY \`FK_c6ae67fefde29efc7325b74baa4\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`films_starships\` DROP FOREIGN KEY \`FK_98904c9cab6a9c3c11aeacf768b\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`people\` DROP FOREIGN KEY \`FK_8f79bb03eba3c1c585da15ef3a6\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`species\` DROP FOREIGN KEY \`FK_8f79bb098a482f95590115ef3a7\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`images\` DROP FOREIGN KEY \`FK_c02a4e67aceb74f955901a6464a\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`images\` DROP FOREIGN KEY \`FK_0ac1a8463eba3c1ce97f04ac097\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`images\` DROP FOREIGN KEY \`FK_53ea6b0269e66436dfe00628f31\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`images\` DROP FOREIGN KEY \`FK_fa13320ccbde4efa91048a55ff4\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`images\` DROP FOREIGN KEY \`FK_0dc8a31ea91d9fe7574c9c6b48c\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`images\` DROP FOREIGN KEY \`FK_7aaee71fd817df85dd0e24d52a6\``,
    )
    await queryRunner.query(
      `DROP INDEX \`IDX_4465b1c1a89520616f3c6ccad7\` ON \`films_vehicles\``,
    )
    await queryRunner.query(
      `DROP INDEX \`IDX_d892418f6e02d0ebce56bd3580\` ON \`films_vehicles\``,
    )
    await queryRunner.query(`DROP TABLE \`films_vehicles\``)
    await queryRunner.query(
      `DROP INDEX \`IDX_f858faa2a7663a7258052fb4e5\` ON \`people_vehicles\``,
    )
    await queryRunner.query(
      `DROP INDEX \`IDX_1228470b9119a37bc0608e7ac6\` ON \`people_vehicles\``,
    )
    await queryRunner.query(`DROP TABLE \`people_vehicles\``)
    await queryRunner.query(
      `DROP INDEX \`IDX_a6ae8e23d835bdbc6b9fe43823\` ON \`people_films\``,
    )
    await queryRunner.query(
      `DROP INDEX \`IDX_f9d0038e205e511024d88b4c44\` ON \`people_films\``,
    )
    await queryRunner.query(`DROP TABLE \`people_films\``)
    await queryRunner.query(
      `DROP INDEX \`IDX_a8db04b134255125a4a990c656\` ON \`films_planets\``,
    )
    await queryRunner.query(
      `DROP INDEX \`IDX_56eec3c43f5246c6a26f4e61d8\` ON \`films_planets\``,
    )
    await queryRunner.query(`DROP TABLE \`films_planets\``)
    await queryRunner.query(
      `DROP INDEX \`IDX_30663fc8495f09199efa33ab85\` ON \`films_species\``,
    )
    await queryRunner.query(
      `DROP INDEX \`IDX_b5b68c8f3779bcdaa9afda0378\` ON \`films_species\``,
    )
    await queryRunner.query(`DROP TABLE \`films_species\``)
    await queryRunner.query(
      `DROP INDEX \`IDX_56f67794e6fc76cd1c1427ed1a\` ON \`people_species\``,
    )
    await queryRunner.query(
      `DROP INDEX \`IDX_3f0fe0fa1df5ad0ef0afc4e9fb\` ON \`people_species\``,
    )
    await queryRunner.query(`DROP TABLE \`people_species\``)
    await queryRunner.query(
      `DROP INDEX \`IDX_25cb50d5fba38a9219e6b2eb79\` ON \`people_starships\``,
    )
    await queryRunner.query(
      `DROP INDEX \`IDX_2ee1350798626e1c52a83f26c0\` ON \`people_starships\``,
    )
    await queryRunner.query(`DROP TABLE \`people_starships\``)
    await queryRunner.query(
      `DROP INDEX \`IDX_c6ae67fefde29efc7325b74baa\` ON \`films_starships\``,
    )
    await queryRunner.query(
      `DROP INDEX \`IDX_98904c9cab6a9c3c11aeacf768\` ON \`films_starships\``,
    )
    ...
    await queryRunner.query(
      `DROP INDEX \`REL_6c40323ce20cc863369cc33ee8\` ON \`films\``,
    )
    ...
    await queryRunner.query(
      `DROP INDEX \`REL_6c65872be20cc863369cc11ee8\` ON \`species\``,
    )
